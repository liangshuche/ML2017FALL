...
result1=model.predict([x_test_user,x_test_movie],batch_size=8192,verbose=1)
model=load_model('model/model_prob3.h5', custom_objects={'rmse':rmse})
result2=model.predict([x_test_user,x_test_movie],batch_size=8192,verbose=1)
