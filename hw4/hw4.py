...
def readnolabeldata(path):
	print('Reading Non-Labeled Data...')
	data=[]
	with open(path) as f:
		for line in f:
			data.append(line)
...
x_train_nolabel=tokenizer.texts_to_sequences(train_nolabel)
...
x_train_nolabel=pad_sequences(x_train_nolabel,maxlen=sequence_len, padding='post')
